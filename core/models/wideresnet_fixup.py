"""
source: https://github.com/valilenk/fixup/blob/master/model.py
"""
import math
import torch
...
class WideResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        z = out.view(-1, self.nChannels)
        y_hat = self.fc(z)

        return y_hat, z


def WideResNet_fixup_no_bn(num_classes):
    return WideResNet(28, num_classes, use_bn=False, use_fixup=True)
